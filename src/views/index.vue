        ...
        <v-list two-line>
          <v-list-item-group>
            <template v-for="(_item, index) in item.hots_list_json">
              <v-list-item :key="_item.title" @click.stop="handlerHref('https://s.weibo.com'+_item.href)">
                <template v-slot:default="{}">
                  <v-list-item-content>
                    ...
                    <v-list-item-subtitle
                      class="text--primary"
                    >
                      <span class="red--text text--lighten-1 sub_title">🔥 {{_item.hotRank}}</span>
                    </v-list-item-subtitle>
                    <v-list-item-subtitle
